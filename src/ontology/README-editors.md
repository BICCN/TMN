These notes are for the EDITORS of TMN
...
Make sure you have an ID range in the [idranges file](TMN-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [TMN-edit.owl](TMN-edit.owl)

** DO NOT EDIT TMN.obo OR TMN.owl in the top level directory **

[../../TMN.owl](../../TMN.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/BICCN/TMN) for details.
 ...
 * [TMN-idranges.owl](TMN-idranges.owl)
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/TMN_terms.txt file
...
Note: the TMN_terms.txt file may include 'starter' classes seeded from
...
This generates derived files such as TMN.owl and TMN.obo and places
 ...
 * https://github.com/BICCN/TMN/releases
 * https://github.com/BICCN/TMN/releases/new
...
what is in the `owl:versionIRI` of the derived TMN.owl (`data-version` in
TMN.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/TMN.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/TMN/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/BICCN/TMN.svg?branch=master)](https://travis-ci.org/patrick-lloyd-ray/TMN)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/BICCN](https://travis-ci.org/profile/BICCN)
 2. click the "Sync account" button
 3. Click the tick symbol next to TMN
