 ...
 * [TMN.yml](TMN.yml)
     * Determines how your purl.obolibrary.org/obo/TMN/ redirects will be handled
     ...
     * Paste in the contents of [TMN.yml](TMN.yml)
 ...
 * [TMN.md](TMN.md)
     ...
     * Paste in the contents of [TMN.md](TMN.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
